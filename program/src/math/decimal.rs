...
impl Decimal {
    ...
    //fixme done
    //todo figure out the difference between floor and ceiling
    //also tries to convert the decimal into u64, but using ceiling not floor
    ...
    //fixme done
    //tries to convert decimal into u64.
    //think about it - this Decimal struct stores a value with 18 0s
    //by dividing by 10*18 we're taking all those values after the decimal out and only keeping the base

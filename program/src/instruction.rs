...
pub enum LendingInstruction {
    ...
    // ============================================================================= reserve = the supply side
    /// Terminology:
    /// Deposit liquidity = deposit coins others can borrow
    /// Redeem collateral = redeem LP tokens in return for original deposited liquidity
    ...
    // ============================================================================= obligation = the borrow side
    /// Deposit/withdraw collateral = deposit coins that guarantee your loan
    /// Borrow liquidity = borrow the coins that the other side deposited
    ...
    ///   todo 9. `[signer]` user transfer authority.
